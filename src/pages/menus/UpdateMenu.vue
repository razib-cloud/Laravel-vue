                    ...
                    <form @submit.prevent="submitData">
                        <div class="app-form">
                            ...
                            <div class="mb-3">
                                ...
                                <input v-model="formData.name" type="text" class="form-control" placeholder="Enter Status" id="status">
                            </div>
...
const fetechMenus = () =>{
    ...
    .then((result)=> {
        ...
        formData.status=  result.data.menus.status 
    })
    .catch((err)=>{
        console.log(err);
...
const submitData= ()=>{
    api.put("/menus/"+ formData.id, formData)
    .then((result)=>{
        console.log(result.data);
