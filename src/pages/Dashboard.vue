            ...
            <div class="row">
              <div class="col-xl-6 col-sm-6">
                <div class="card">
                  ...
                  >
                    <div class="menu">
                      <span class="font-w500 fs-16 d-block mb-2"
                        >Total Menus</span
                      >
                      <h2>459</h2>
                    </div>
                    ...
                    >
                      <span
                        class="donut1"
                        data-peity='{ "fill": ["rgb(98, 79, 209,1)", "rgba(247, 245, 255)"],   "innerRadius": 35, "radius": 10}'
                        >5/8</span
                      >
            ...
            <div class="card">
              <div class="card-header border-0 flex-wrap pb-0">
                ...
                <div>
                  ...
                  <p class="mb-0 font-w700">
                    <span class="text-success">0,5% </span>than last day
                  </p>
                </div>
              </div>
              ...
              <div class="col-xl-12">
                <div class="card">
                  ...
                  <div class="card-body pb-0">
                    <div
                      class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom"
                    >
                      <span class="num">#1</span>
                      <div class="me-auto pe-3">
                        <a href="ecom-product-grid.html"
                          ><h2 class="text-black fs-14 font-w600">
                            Medium Spicy Spagethi Italiano
                          </h2></a
                        >
                        <span class="text-black font-w600 d-inline-block me-3"
                          >$5.6
                        </span>
              ...
              <div class="col-xl-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div
                      class="d-flex align-items-end mt-2 pb-4 justify-content-between"
                    >
                      <span class="fs-16 text-primary font-w600">#pizza</span>
                      <span class="fs-14"
                        ><span class="text-black pe-2"></span>452 times</span
                      >
                    </div>
                    <div class="progress default-progress">
                      <div
                    ...
                    <div
                      class="d-flex align-items-end mt-2 pb-4 justify-content-between"
                    >
                      <span class="fs-16 text-primary font-w600"
                        >#breakfast</span
                      >
                      <span class="fs-14"
                        ><span class="text-black pe-2"></span>97 times</span
                      >
                    </div>
                    <div class="progress default-progress">
                      <div
                    ...
                    >
                      ...
                      <span class="fs-14"
                        ><span class="text-black pe-2"></span>61 times</span
                      >
                    </div>
                    <div>
                      ...
                      <div>
                        <a
                          ...
                          class="btn btn-outline-primary btn-rounded me-2 mb-3 btn-sm"
                          >#japanessefood</a
                        >
                        <a
                          href="javascript:void(0);"
                          class="btn btn-outline-primary btn-rounded mb-3 btn-sm"
                          >#design</a
                        >
                        <a
                          href="javascript:void(0);"
                        ...
                        <a
                          href="javascript:void(0);"
                          class="btn btn-outline-primary btn-rounded btn-sm mb-3"
                          >16+</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="card-header border-0 flex-wrap">
                    ...
                    <div class="d-flex">
                      ...
                      <div class="dropdown custom-dropdown mb-0 ms-3">
                        <div
                          class="btn sharp tp-btn dark-btn"
                ...
                <div class="row">
                  <div class="col-xl-12">
                    <div class="card customer-wrapper">
                      ...
                      <div
                        class="card-body height400 loadmore-content dz-scroll pb-0 pt-0"
                        id="CustomerListContent"
                      >
                        <div class="d-flex align-items-center mb-4">
                          <div class="recent-customer me-3">
                            <img
                              src="/images/contacts/c1.jpg"
                              width="50"
                              alt=""
                            />
                          </div>
                      ...
                      <div class="card-footer border-0 down-arrow pb-0">
                        <a
                          href="javascript:void(0);"
                          class="dz-load-more fas fa-chevron-down"
                          id="CustomerList"
                          rel="ajax/customer-list.html"
                        ></a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-xl-12">
                    <div class="card">
                      ...
                      <div class="card-body pb-0">
                        ...
                        <div
                          class="loadmore-content dz-scroll"
                          id="DelieveryListContent"
                        >
                          <div
                          ...
                          >
                            <div class="delivery-customer me-auto mb-2">
                              ...
                              <div>
                                <span class="font-w600 text-black fs-16"
                                  >John Kusnaidi
                                  <span class="text-primary"
                                    >(4 Items)</span
                                  ></span
                                >
                                <span class="d-block fs-12 font-w600"
                                  >Will be shipping on 11 : 24 AM</span
                                >
                              </div>
                            </div>
                            <div
                            ...
                            >
                              <div>
                                <span class="d-block f-s14 font-w400 text-black"
                                  >Franklin Avenue St. London, ABC 12345</span
                                >
                                <span
                                  class="text-end f-s14 font-w400 text-black"
                                  >United Kingdom</span
                                >
                              </div>
                          ...
                          >
                            ...
                            >
                              <div>
                                <span class="d-block f-s14 font-w400 text-black"
                                  >Groove Street Families, DEF 244125</span
                                >
                                <span
                                  class="text-end f-s14 font-w400 text-black"
                                  >United Kingdom</span
